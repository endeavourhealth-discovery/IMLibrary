...
export function byPriority(a: any, b: any): number {
  if (!isObjectHasKeys(a, ["priority"]) || !isObjectHasKeys(b, ["priority"]))
    return 0;
...
export function byScheme(a: any, b: any): number {
  if (!isObjectHasKeys(a, ["scheme"]) || !isObjectHasKeys(b, ["scheme"]))
    return 0;
...
export function byLabel(a: any, b: any): number {
  if (!isObjectHasKeys(a, ["label"] || !isObjectHasKeys(b, ["label"])))
    return 0;
  if (a.label < b.label) {
    return -1;
...
export function byPosition(a: any, b: any): number {
  if (!isObjectHasKeys(a, ["position"] || !isObjectHasKeys(b, ["position"])))
    return 0;
...
export function byOrder(a: any, b: any): number {
  if (!isObjectHasKeys(a, ["order"] || !isObjectHasKeys(b, ["order"])))
    return 0;
  if (a.order < b.order) {
    return -1;
